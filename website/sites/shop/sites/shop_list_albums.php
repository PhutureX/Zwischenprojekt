<div id="shop-list" class="shop-wrapper">
            ...
            <div class="shop-list-box">
              <?php
                $sql = "SELECT products.id,category_id, name, price, sale, price_sale, min(product_imgs.path) AS path FROM products LEFT JOIN product_imgs ON products.id = product_imgs.product_id WHERE category_id = 6 GROUP BY products.id";
